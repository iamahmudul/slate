...
| **1 — Slate v1 MVP** | Working offline app, fixed 4 tabs (Today / Topics / Tracker / Notes), packaged | `specs/001-menu-bar-app/{spec.md,plan.md,tasks.md}`; implemented via Claude Code; tagged `v0.1.0` | Done |
